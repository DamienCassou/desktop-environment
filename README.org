...
| desktop-environment-previous-song               | ~<XF86AudioPrev>~           |
| desktop-environment-next-song                   | ~<XF86AudioNext>~           |
...
| ~desktop-environment-toggle-music-command~                | Shell command toggling the music player                                    |
| desktop-environment-previous-song-command                 | Shell command for going to previous song                                   |
| desktop-environment-next-song-command                     | Shell command for going to next song                                       |
